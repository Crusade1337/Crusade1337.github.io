...
(async () => {
    ...
    SnipeTool = {
        ...
        init: function () {
            ...
            document.getElementById("autoSend").checked = this.autoSend;
            if (this.timeGoal !== 0) {
        ...
        retrieveInput: function () {
            ...
            timegoal.addEventListener("input", () => {
                ...
                // A new goal was set, so allow auto-send to fire again for it.
                this.sent = false;
                this.updateSettings();
            });
            ...
            autoSend.addEventListener("input", () => {
                this.autoSend = document.getElementById("autoSend").checked;
                this.sent = false;
                this.updateSettings();
            });
        },
